...
public:
    ...
    int getYPicked();
	 ...
	 /**
     * \brief Set probe calibration flag
     * \param[in] flag
     */
	...
	vtkSmartPointer<vtkTracerInteractorStyle> tracerStyle; ///<Trace in an image
    bool probeFlag; ///<Flag to know if you are gint to calibrate the probe
